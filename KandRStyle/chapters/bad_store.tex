...
\endnote{[4]}  \_\_\_\_\_.  "Bad Store 1.2.3," Vulnhub.  INTERNET:  \url{https://www.vulnhub.com/entry/badstore-123,41/}\endnote{\url{https://www.vulnhub.com/entry/badstore-123,41/}} 
...
\endnote{[9]} Abouzeid, Halim.  "From SQL Injection to WebShell"  RSA.  INTERNET:  \url{https://community.rsa.com/community/products/netwitness/blog/2017/04/10/from-sql-injection-to-webshell}\endnote{\url{https://community.rsa.com/community/products/netwitness/blog/2017/04/10/from-sql-injection-to-webshell}}
...
\endnote{[10]} \_\_\_\_\_.  INTERNET:  \url{https://w00troot.blogspot.com/2017/05/getting-reverse-shell-from-web-shell.html}\endnote{\url{https://w00troot.blogspot.com/2017/05/getting-reverse-shell-from-web-shell.html}}
Some reverse shell script suggestions for various systems.  

\endnote{[11]} \_\_\_\_\_.  INTERNET:  \url{https://www.darkmoreops.com/2014/08/28/use-sqlmap-sql-injection-hack-website-database/}\endnote{\url{https://www.darkmoreops.com/2014/08/28/use-sqlmap-sql-injection-hack-website-database/}}
...
\endnote{[12]} \_\_\_\_\_.  INTERNET:  \url{https://sneakerhax.com/tool-tips-sqlmap-with-post-requests/}\endnote{\url{https://sneakerhax.com/tool-tips-sqlmap-with-post-requests/}}
...
\endnote{[13]}  INTERNET:  \url{https://dev.mysql.com/doc/refman/5.5/en/create-user.html}\endnote{\url{https://dev.mysql.com/doc/refman/5.5/en/create-user.html}}
...
\endnote{[14]}  INTERNET:  \url{https://dev.mysql.com/doc/refman/5.5/en/grant.html}\endnote{\url{https://dev.mysql.com/doc/refman/5.5/en/grant.html}}
Commands for GRANT with MySQL.  Critical basic commands for setting privileges on an account with MySQL.

\endnote{[15]}  INTERNET:  \url{https://stackoverflow.com/questions/1708409/how-to-start-mysql-with-skip-grant-tables}\endnote{\url{https://stackoverflow.com/questions/1708409/how-to-start-mysql-with-skip-grant-tables}}
Stack Overflow post suggesting that skip grant tables might be overridden with reconfiguring some ini files.

\endnote{[16]}  INTERNET:  \url{https://superuser.com/questions/1127299/how-to-restart-mysql-with-skip-grant-tables-if-you-cant-use-the-root-password}\endnote{\url{https://superuser.com/questions/1127299/how-to-restart-mysql-with-skip-grant-tables-if-you-cant-use-the-root-password}}
...
\endnote{[17]}  INTERNET:  \url{http://seclists.org/metasploit/2012/q3/40}\endnote{\url{http://seclists.org/metasploit/2012/q3/40}}
Got turned on to \texttt{spool} for Metasploit commands.

\endnote{[18]}  INTERNET: \url{http://www.guninski.com/modproxy1.html}\endnote{\url{http://www.guninski.com/modproxy1.html}}
Post on \texttt{mod\_proxy}

\endnote{[19]}  INTERNET: \url{https://hack2rule.wordpress.com/2017/02/25/sql-injection-to-meterpreter/}\endnote{\url{https://hack2rule.wordpress.com/2017/02/25/sql-injection-to-meterpreter/}}
Blog post on using \texttt{sqlmap}, \texttt{Meterpreter}, \texttt{Burp} and others.

\endnote{[20]}  INTERNET: \url{https://github.com/sqlmapproject/sqlmap/wiki/Usage}\endnote{\url{https://github.com/sqlmapproject/sqlmap/wiki/Usage}}
\texttt{sqlmap} github site explaining the usage of the arguments; man pages.

\endnote{[21]}  INTERNET: \url{https://www.tutorialspoint.com/perl/perl_cgi.htm}\endnote{\url{https://www.tutorialspoint.com/perl/perl_cgi.htm}}
...
\endnote{[22]}  Kamthan, Pankaj.  INTERNET: \url{https://www.irt.org/articles/js184/#origins_consequences}\endnote{\url{https://www.irt.org/articles/js184/#origins_consequences}}
...
\endnote{[23]}  INTERNET: \url{https://httpd.apache.org/docs/2.4/howto/cgi.html}\endnote{\url{https://httpd.apache.org/docs/2.4/howto/cgi.html}}
Apache documentation on setting up CGI with Apache 2.4.

\endnote{[24]}  INTERNET: \url{https://www.techrepublic.com/article/get-it-done-installing-apache-web-server-on-linux/}\endnote{\url{https://www.techrepublic.com/article/get-it-done-installing-apache-web-server-on-linux/}}
...
\endnote{[25]}  INTERNET: \url{https://www.cybrary.it/forums/topic/how-to-bypass-error-403-forbidden/}\endnote{\url{https://www.cybrary.it/forums/topic/how-to-bypass-error-403-forbidden/}}
Forum posts on other people getting 403s.  No big surprises here; but some sound advice on a statement of the conditions.

\endnote{[26]}  INTERNET: \url{https://www.cybrary.it/2015/05/summarizing-the-five-phases-of-penetration-testing/}\endnote{\url{https://www.cybrary.it/2015/05/summarizing-the-five-phases-of-penetration-testing/}}
Description of the five phases of pentesting.

\endnote{[27]}  INTERNET: \url{https://www.offensive-security.com/metasploit-unleashed/scanner-http-auxiliary-modules/}\endnote{\url{https://www.offensive-security.com/metasploit-unleashed/scanner-http-auxiliary-modules/}}
...
\endnote{[28]}  INTERNET: \url{https://www.rapid7.com/db/modules/auxiliary/scanner/ssl/openssl_heartbleed}\endnote{\url{https://www.rapid7.com/db/modules/auxiliary/scanner/ssl/openssl_heartbleed}}
Rapid7's description of an openssl\_heartbleed scanner in Metasploit.

\endnote{[29]}  INTERNET: \url{https://www.trojanhorsesecurity.com/shellshock}\endnote{\url{https://www.trojanhorsesecurity.com/shellshock}}
Trojan Horse Security's description of a Shellshock scanner and exploit in Metasploit.

\endnote{[30]}  INTERNET: \url{https://www.rapid7.com/db/modules/exploit/multi/http/apache_mod_cgi_bash_env_exec}\endnote{\url{https://www.rapid7.com/db/modules/exploit/multi/http/apache_mod_cgi_bash_env_exec}}
Rapid7's description of a Shellshock exploit in Metasploit.

\endnote{[31]}  INTERNET: \url{https://bytebin.wordpress.com/2011/04/25/how-to-check-debian-boot-log-messages/}\endnote{\url{https://bytebin.wordpress.com/2011/04/25/how-to-check-debian-boot-log-messages/}}
Blog post on where to find Debian boot logs.  Useful notes when we were trying to locate BadStore VM's boot-up information.

\endnote{[32]}  INTERNET: \url{https://www.cvedetails.com/vulnerability-list/vendor_id-185/product_id-316/version_id-31799/Mysql-Mysql-4.0.25.html}\endnote{\url{https://www.cvedetails.com/vulnerability-list/vendor_id-185/product_id-316/version_id-31799/Mysql-Mysql-4.0.25.html}}
Web page on some CVEs related to early versions of MySQL.

\endnote{[33]}  INTERNET: \url{https://packetstormsecurity.com/files/128447/Apache-mod_cgi-Bash-Environment-Variable-Code-Injection.html}\endnote{\url{https://packetstormsecurity.com/files/128447/Apache-mod_cgi-Bash-Environment-Variable-Code-Injection.html}}
Blog post outlining the source code for a custom Metasploit module to work against Apache mod_cgi Bash.

\endnote{[34]}  INTERNET: \url{https://www.digitalocean.com/community/tutorials/how-to-use-passwd-and-adduser-to-manage-passwords-on-a-linux-vps}\endnote{\url{https://www.digitalocean.com/community/tutorials/how-to-use-passwd-and-adduser-to-manage-passwords-on-a-linux-vps}}
Tutorial on \texttt{/etc/passwd} that helped us understand what we saw when we downloaded a copy from BadStore.

\endnote{[35]}  INTERNET: \url{https://www.tldp.org/LDP/sag/html/adduser.html}\endnote{\url{https://www.tldp.org/LDP/sag/html/adduser.html}}
Linux Documentation Project's page on how to add a user.

\endnote{[36]}  INTERNET: \url{https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-115.pdf}\endnote{\url{https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-115.pdf}}
