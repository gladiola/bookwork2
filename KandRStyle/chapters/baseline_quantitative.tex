...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{0.18\linewidth}p{0.18\linewidth}p{0.18\linewidth}p{0.14\linewidth}p{0.22\linewidth}@{}}
    ...
    \midrule
    Phishing\index{phishing} & Lower Bound Computations & Section~\ref{sec:phishing} & page~\pageref{sec:phishing} & (subsection) \\
    ...
    \midrule
    Ransomware\index{ransomware} & Lower Bound Computations & Section~\ref{sec:ransomware} & page~\pageref{sec:ransomware} & (subsection) \\
