...
\section{Establishing a BIND DNS Server with MX to an Encrypted Email Provider}


We quickly established a BIND9 DNS server, using this tutorial: \endnote{[1]}
...
\endnote{[1]} \_\_\_\_\_.  INTERNET:   \texttt{https://blog.andreev.it/?p=4096}\endnote{\url{https://blog.andreev.it/?p=4096}}
