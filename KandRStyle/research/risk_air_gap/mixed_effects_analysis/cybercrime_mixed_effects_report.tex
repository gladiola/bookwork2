...
The long-format dataset contains 231 state-year-category rows. One workbook error cell was read as missing, so 230 complete observations were used in the mixed-effects model.
