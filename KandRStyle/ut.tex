...
\begin{figure}[h!]
  ...
  \caption{Example run of a Monte Carlo simulation using state-level data to set bounds.  Here we chose Personal Data Breach victim counts from 2016 and 2022 as upper and lower bounds. 10,000 rows projected randomized values between these bounds and determined mean and counts by confidence interval.
