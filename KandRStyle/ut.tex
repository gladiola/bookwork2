...
In the mechanics of web programs' carrying data from one program to another, some attackers have been able to find common points of manipulation.  One such area is URL encoding.  In the address bar of our browsers, we can see directory-based information that describes where files are stored.  Also in those URL addresses, we can see an opportunity to carry data from one program to another.  It's in that carrying of data that attackers can seek to inject their own.  Attacks that inject data for the purpose of striking at underlying databases fall into the category of SQL Injection attacks ("SQLIATK").  \endnote{Tatroe, Kevin and Peter MacIntyre, Rasmus Lerfdorf. Programming PHP. O'Reilly, third edition, 2013. ISBN 978-1-449-39277-2. A general overview of the language is presented in this manual.} \endnote{Regalado, Daniel, et. al. Grey Hat Hacking: The Ethical Hacker's Handbook. pp.385-414. McGraw Hill Education, fourth edition, 2015. ISBN 978-0-183238-0. Regalado's book on hacking is an aggregate of his and other's works. It offers chapters on different flavors of hacking, with variance by system type, target type, and mode of attack. The chapters feature many examples and provide a discourse on the common patterns of attack.}

SQL Injection attacks are some of the most common attacks on web programs.  Functions that allow programmers to validate and sanitize inputs have been a common defense against these attacks.  Those defenses have been available for a long time through widely circulated, standardized methods that are often official parts of published web languages like PHP.  \endnote{\_\_\_\_\_. "http://php.net/manual/en/security.database.sql-injection.php" INTERNET. PHP Manua, Security, Database Security. PHP Manual entry on SQL Injection.} Yet, despite the availability of these common and easy-to-use defense mechanisms, SQL Injection attacks continue to plague the web.  An OWASP study of the Top 10 Web Vulnerabilities in 2004 listed "Injection Flaws" as 6/10. A similar listing by OWASP in 2013 placed "Injection" at number one.  \endnote{Regalado, Daniel, et. al. Grey Hat Hacking: The Ethical Hacker's Handbook. pp.385-414. McGraw Hill Education, fourth edition, 2015. ISBN 978-0-183238-0. Regalado's book on hacking is an aggregate of his and other's works. It offers chapters on different flavors of hacking, with variance by system type, target type, and mode of attack. The chapters feature many examples and provide a discourse on the common patterns of attack.} As this report is being written, OWASP is considering its Top 10 list for 2017.  "Injection" is still at number one. \endnote{\_\_\_\_\_. "https://owasp.org/index.php/Top\_10\_2013-Top\_10" OWASP, 2017. INTERNET.}  A combination of hasty programming, poor systems design, and lack of review and repairs seem to be the leading causes of promoting these vulnerabilities on the web.  Shortly behind, we see the exploiting attacks follow.

By using SQL Injection, attackers can download, displace or destroy data.  The risk to users, customers, clients, businessess and stakeholders is significant because these vulnerabilites are so easy to exploit that automated attack tools are publicly available and widely distributed. \endnote{Weidman, Georgia. Penetration Testing: A Hands-On Introduction to Hacking. No Starch Press, 2014. ISBN 978-1-59327-564-8. This book provided strong references and tutorials for common pen-testing methods. While slightly dated, aside from the technological limitations that have arisen after publication, Weidman's book provides another view of a common path in pen-testing, and therefore, hacking, web programs.} SQL Injection attacks will remain a significant part of information security for the foreseeable future because, like many attacks on data in motion or data at rest, they are abuses of inherent characteristics.  The same qualities that describe and define stateless transfer of data on the web create the very conditions to make a program susceptible to injection attacks.  Therefore, because URL-encoded data transfers are a normal and legitimate part of web traffic we will continue to see injection attacks occur.

Risk assessments are at the core of any effective information security policy. \endnote{Shelly, Gary B. and Harry J. Rosenblatt. Systems Analysis and Design. Course Technology. PP.570-615. CENGAGE Learning, ninth edition, 2012. ISBN 978-1-133-27405-6.} Without correct threat modelling, defining and describing expected methods of attacks, information technology professionals would not be able to mount an effective defense of their networks.  Every day new attack tools surface.  It's evident that skilled programmers can craft their own attacks using common programming tools and specialized libraries. \endnote{Weidman, Georgia. Penetration Testing: A Hands-On Introduction to Hacking. No Starch Press, 2014. ISBN 978-1-59327-564-8. This book provided strong references and tutorials for common pen-testing methods. While slightly dated, aside from the technological limitations that have arisen after publication, Weidman's book provides another view of a common path in pen-testing, and therefore, hacking, web programs.} \endnote{Regalado, Daniel, et. al. Grey Hat Hacking: The Ethical Hacker's Handbook. pp.385-414. McGraw Hill Education, fourth edition, 2015. ISBN 978-0-183238-0. Regalado's book on hacking is an aggregate of his and other's works. It offers chapters on different flavors of hacking, with variance by system type, target type, and mode of attack. The chapters feature many examples and provide a discourse on the common patterns of attack.} \endnote{Seitz, Justin. Black Hat Python: Python Programming for Hackers and Pentesters. No Starch Press, second printing, 2014. ISBN 978-1-59327-590-7. This book is a common reference that provides insight into how short Python scripts can be used to quickly generate original programs that can be used for network attacks. It suggests that skilled attackers do not need to rely on prefabricated tools. Also, the commonailty of function between the programs demonstrated and other common resources shows a unity in capability.} The most dangerous attack tools appear to be the most automated.

I feel that the most automated tools are the most dangerous because they imply a lower level of operator skill required to execute the programs.  This supports a broad user base of attackers.  Some of these programs come with online tutorials, manuals \endnote{\_\_\_\_\_. SCRT Information Security, "https://www.scrt.ch/outils/mms/mms\_manual.pdf" INTERNET.} and demonstrations \endnote{Fresnillo, Rodolfo Resendez. YouTube, "MiniMysqlator \& Pblind", "https://www.youtube.com/watch?v=uK3\_qR3Kn\_g" YouTube,10AUG2010, INTERNET. This is the link to the video where I first saw MiniMysqlator being used.}.  Downloading the attack programs is often no more difficult than downloading any other program on the web. \endnote{\_\_\_\_\_. SCRT Information Security, "https://www.scrt.ch/en/attack/downloads/mini-mysqlat0r" INTERNET. This attack tool is published on the Internet. I have seen real-world situations in which I believe it was used to attack the websites of my commercial clients. I first spotted it in a YouTube video that was recorded as an instructive example by hackers for hackers. I decided to include it in the attack suites for the experiment based on my belief that it was an actual attack tool used by skiddies and hackers. It is an automated SQL Injection Attack Tool packaged in Java with a Swing interface.}  At work I have witnessed the effects of these kinds of programs; that is, the heavy use of automated attacks can lead to an availability problem for web programs.  While the individual attacks themselves, hit-by-hit, may be ineffective, the deluge of rapid-fire requests as HTTP calls may still each require a response from the server, albeit dismissive.
...
"Randomized Experiment: An experiment in which units are assigned to receive the treatment or an alternative condition by a random process ... \endnote{Ibid.}"
...
"Natural Experiment: Not really an experiment because the cause usually cannot be manipulated; a study that contrasts a naturally occurring event such as an earthquake with a comparison condition. \endnote{Ibid.}"
...
"Quasi-experiments share with all other experiments a similar purpose -- to test descriptive causal hypotheses about manipulatable causes ... \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}(p. 14)"
...
We know that large DDoS attacks like the Mirai botnet can reasonably make static defense inadequate \endnote{\_\_\_\_\_. "Internet of Things DDoS White Paper." Electricity Information Sharing and Analysis Center, IOT\_DDOS\_Whitepaper.pdf. This report described some contemporary cyberattacks. It included coverage of the Mirai botnet and other large attacks.}.  We see attacks like these as prevalent threats.  They are occurring with such frequency that noting the latest newsworthy attack by its timely characteristic like size, victimization base, owner of breached computer, etc., is more likely to date our views than to describe the urgency of defending against attacks like these.  We can see that, in general, cybersecurity threats have risen to the attention of the general public.  Of these threats, different varieties of injection attacks, taken together, have a leading influence.
...
I am looking forward to these upcoming months in which I will carry out some of these experiments.  I'm excited to get started with practical experimentation.  Can we see the compromises that can occur during SQLIATK that I've witnesses in past attack and reversing classes?  What will those attack successes look like?  Will expected defensive conditions hold?  Will expected weaknesses show failure?  Very exciting.
...
Enter {\it msfvenom -l payloads} (Figure \ref{fig:WeidmanCH4PresentationB4}).  Review the possible payloads.  Notice that the payloads are grouped by architecture and platform.  To specify those, arguments of "-a" and "--platform" would be used in the command to generate the exploit.  Sometimes this is a critical aspect of changing the payload to work on the targeted system.  In the case of this example, we did not need to change the payload; but, if we did, these would be the arguments that we would begin experimenting with.
...
{\it msfvenom} \textless target computer specific payload\textgreater \textless listening computer address\textgreater \textless listening computer port\textgreater [other arguments]
...
\begin{figure}[h!]
  ...
  \caption{Screenshot of copying the exploit-carrying file to a web server directory and starting the web server.}
...
set LPORT \textless listener PORT\textgreater 12345
exploit}
...
(U+00A3) instead of a \#.  This led me back into the setup and configuration routine for the Pi using a command line program, raspi-config.  I worked through those dialogues and set up my computer for use in my area with the equipment on hand.
...
% REF IOT DDOS
\bibitem{IOTDDOS}
 \_\_\_\_\_.  "Internet of Things DDoS White Paper."  Electricity Information Sharing and Analysis Center, IOT\_DDOS\_Whitepaper.pdf.
...
\_\_\_\_\_.  "Framework for Improving Ciritcal Infrastructure Cybersecurity."  NIST, 2014.
...
\_\_\_\_\_.  SCRT Information Security, "https://www.scrt.ch/en/attack/downloads/mini-mysqlat0r" INTERNET.
...
\_\_\_\_\_.  "https://www.nist.gov/news-events/events/2017/03/cybersecurity-framework-virtual-events" NIST, INTERNET.
...
%REF Jared Haight
\bibitem{JaredHaight}
Haight, Jared.  "Introduction to Powershell and How to Use It for Evil."  Information Security Lecture sponsored by B-Sides Charleston.  Charleston, SC, USA.  April 2017.
...
% Shadish Text
% Quotations from William Shadish's book, Experimental and Quasi-Experimental Designs for Generalized Causal Inference. \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}

%REF Shadish
\bibitem{Shadish2A}
Shadish, William, \endnote{Ibid.}, pp. 2-3:
"But when scientists started to use experiments in areas such as public health or education, in which extraneous influences are harder to control ... they found that the controls used in natural science in the laboratory worked poorly in these new applications.  So they developed new methods of dealing with extraneous influence, such as random assignment (Fisher, 1925) or adding a nonrandomized control group (Coover \& Angell, 1907).  As theoretical and observational experience accumulated across these settings and topics, more sources of bias were identified and more methods were developed to cope with them (Dehue, 2000)."

%REF Shadish
\bibitem{Shadish3B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 3 :
...
%REF Shadish
\bibitem{Shadish3C}
Shadish, William, \endnote{Ibid.}, p. 3:
...
%REF Shadish
\bibitem{Shadish4A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 4:
...
%REF Shadish
\bibitem{Shadish4B}
Shadish, William, \endnote{Ibid.}, p. 4:
...
%REF Shadish
\bibitem{Shadish5A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 5:
...
%REF Shadish
\bibitem{Shadish5B}
Shadish, William, \endnote{Ibid.}, p. 5:
...
%REF Shadish
\bibitem{Shadish6A}
Shadish, William, \endnote{Ibid.}, p. 6:
"How do we know if cause and effect are related?  In a classic analysis formalized by the 19th-centure philosopher John Stuart Mill, a causal relationship exists if (1) the cause preceded the effect, (2) the cause was related to the effect, and (3) we can find no plausible alternative explanation for the effect other than the cause."

%REF Shadish
\bibitem{Shadish7A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 7:
...
%REF Shadish
\bibitem{Shadish7B}
Shadish, William, \endnote{Ibid.}, p. 7:
...
%REF Shadish
\bibitem{Shadish9A}
Shadish, William, \endnote{Ibid.}, p. 9:
...
%REF Shadish
\bibitem{Shadish9B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 9:
"... the conditions under which that causal relationship holds -- what we call causal explanation."

%REF Shadish
\bibitem{Shadish10A}
Shadish, William, \endnote{Ibid.}, p. 10:
...
%REF Shadish
\bibitem{Shadish10B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 10:
...
%REF Shadish
\bibitem{Shadish11A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 11:
...
%REF Shadish
\bibitem{Shadish11B}
Shadish, William, \endnote{Ibid.}, p. 11:
...
%REF Shadish
\bibitem{Shadish12A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 12:
...
%REF Shadish
\bibitem{Shadish14A}
Shadish, William, \endnote{Ibid.}, p. 14:
...
%REF Shadish
\bibitem{Shadish15A}
Shadish, William, \endnote{Ibid.}, p. 15:
...
%REF Shadish
\bibitem{Shadish15B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 15:
...
%REF Shadish
\bibitem{Shadish16A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 16:
...
%REF Shadish
\bibitem{Shadish16B}
Shadish, William, \endnote{Ibid.}, p. 16:
...
%REF Shadish
\bibitem{Shadish17A}
Shadish, William, \endnote{Ibid.}, p. 17:
...
%REF Shadish p.18A
\bibitem{Shadish18A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p.18.
...
%REF Shadish
\bibitem{Shadish19A}
Shadish, William, \endnote{Ibid.},p.19:
"In defining generalization as a problem, we do not assume that more broadly applicable results are always more desirable."

%REF Shadish
\bibitem{Shadish19B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.},p.19:
...
%REF Shadish
\bibitem{Shadish20A}
Shadish, William, \endnote{Ibid.}, p. 20:
...
%REF Shadish
\bibitem{Shadish20B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 20:
...
%REF Shadish
\bibitem{Shadish21A}
Shadish, William, \endnote{Ibid.}, p. 21:
...
%REF Shadish
\bibitem{Shadish21B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 21:
...
%REF Shadish
\bibitem{Shadish22A}
Shadish, William, \endnote{Ibid.}, p. 22:
"Whichever way the causal generalization issue is framed, experiments do not seem at first glance to be very useful."

%REF Shadish
\bibitem{Shadish22B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 22:
...
%REF Shadish
\bibitem{Shadish23A}
Shadish, William, \endnote{Ibid.}, p. 23:
...
%REF Shadish
\bibitem{Shadish23B}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 23:
...
%REF Shadish
\bibitem{Shadish24A}
Shadish, William, \endnote{Shadish, William, et al. Experimental and Quasi-Experimental Designs for Generalized Causal Inference. Wadsworth, CENGAGE Learning, 2002. ISBN 978-0-395-61556-0. Shadish's work extensively influenced this paper. Shadish, who died in 2016, served as a professor at the University of Memphis and the University of California Merced. He studied and published on experimental design for most of his career. Shadish's work was directed primarily at the fields of psychology and education; but, his analysis of experimentation was so thorough that most of his descriptions and advice can be directed towards computer science. Since the structure of experimenting with cyber-attack situations are similar to the structure of the study of social problems, most of his work directly translates into today's attack-and-defense practices for information security. I first came across Shadish's work in Benjamin Dean's article. Shadish's writing served as a strong influence on my research into these topics.}, p. 24:
...
%REF Lin
\bibitem{LinH96A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 96-97
...
%REF Lin
\bibitem{LinH97B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 97-98:
...
%REF Lin
\bibitem{LinH98B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 98:
...
%REF Lin
\bibitem{LinH99B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 99-100:
...
%REF Lin
\bibitem{LinH100A}
Lin, Herbert, \endnote{Ibid.}, p. 100:
...
%REF Lin
\bibitem{LinH101A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 101:
"The conventional wisdom has a grain of truth to it -- technical forensics alone cannot lead to high-confidence attribution. \textsuperscript{45}  Caloyannides goes so far as to assert that 'forensics' presumed usefulness against anyone with computer savvy is minimal because such persons can readily defeat forensics techniques.  Because computer forensics can't show who put the data where forensics found it, it can be evidence of nothing.' \textsuperscript{46}"

%REF Lin
\bibitem{LinH101B}
Lin, Herbert, \endnote{Ibid.}, p.  101:
...
\bibitem{LinH101C}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 101:
"Behavioral information can also contribute to attribution judgments.  For example, Carlin notes that useful clues may be found in the kinds of malware that intruders use and in the way they communicate with their victims. \textsuperscript{48}"

%REF Lin
\bibitem{LinH102A}
Lin, Herbert, \endnote{Ibid.}, p. 102:
...
%REF Lin
\bibitem{LinH102B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p.  102:
...
%REF Lin
\bibitem{LinH103A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 103:
...
%REF Lin
\bibitem{LinH103B}
Lin, Herbert, \endnote{Ibid.}, p. 103:
"HUMINT is not necessarily clandestine."


%REF Lin
\bibitem{LinH104A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 104:
"Geopolitical circumstances could provide clues as to who would want to launch a particular intrusion."


%REF Lin
\bibitem{LinH104B}
Lin, Herbert, \endnote{Ibid.}, p. 104:
...
%REF Lin
\bibitem{LinH105A}
Lin, Herbert, \endnote{Ibid.}, p. 105-106:
...
%REF Lin
\bibitem{LinH106A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 106
...
%REF Lin
\bibitem{LinH106B}
Lin, Herbert, \endnote{Ibid.}, p. 106-107
...
%REF Lin
\bibitem{LinH107A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 107:
...
%REF Lin
\bibitem{LinH107B}
Lin, Herbert, \endnote{Ibid.}, p. 107:
...
\item Novetta's report, 'Operation SNM: Axiom Threat Actor Group Report' ... \textsuperscript{59}...
\item CrowdStrike's report, 'CrowdStrike Intelligence Report: Putter Panda' ... \textsuperscript{60}..."
 \end{itemize}

%REF Lin
\bibitem{LinH108A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an attack be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 108-109
...
%REF Lin
\bibitem{LinH110A}
Lin, Herbert, \endnote{Ibid.}, p. 110:
...
%REF OWASPZaw
\bibitem{OWASPZaw17A}
Watson, Collin and Tin Zaw, \endnote{Watson, Colin and Tin Zaw. OWASP Automated Threat Handbook: Web Applications. Version 1.1, OWASP Foundation, November 2016. ISBN 978-1-329-42709-9.}, p. 17:
...
Interview, Marcus Ranum and Wendy Nather, \endnote{Ibid.}:
...
\bibitem{OWASPZaw8A}
Watson, Collin and Tin Zaw, \endnote{Watson, Colin and Tin Zaw. OWASP Automated Threat Handbook: Web Applications. Version 1.1, OWASP Foundation, November 2016. ISBN 978-1-329-42709-9.}, p. 8, Figure 1:
Glossary of attack terms collected from OWASP Automated Threat Handbook PDF Online Version.
\url{https://www.owasp.org/index.php/File:Automated-threat-handbook.pdf}
...
Stallings, William. \endnote{Ibid.}  p. 355 RFCs for Intrusion Detection Exchange Format:
\begin{itemize}
...
Poor password choices, from Stallings, roughly 25\% of passwords could be cracked using four strategies:
\begin{itemize}
...
Stallings, William. \endnote{Ibid.}  p. 363
...
\bibitem{VanillaEIP}
\_\_\_\_\_.  "0x0 Exploit Tutorial: Buffer Overlow - Vanilla EIP Overwrite," INTERNET:  http://www.primalsecurity.net/0x0-exploit-tutorial-buffer-overflow-vanilla-eip-overwrite-2/
...
\bibitem{PSHash}
Powershell to get the hash of a download on Windows 10:
...
\_\_\_\_\_.  INTERNET:  https://motherboard.vice.com/en\_us/article/vv7zn9/surprise-scans-suggest-hackers-put-imsi-catchers-all-over-defcon
...
\_\_\_\_\_.  INTERNET:  https://www.raspberrypi.org/documentation/configuration/raspi-config.md
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_dataBreach.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 0 and 2 possible data breaches over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-databreach-count-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_dataBreach_percentile.png}}}
  ...
  \label{fig:screenshot-montecarlo-databreach-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_dataBreach_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the breach would cost at \$0.  We set an upper bound that the breach would cost \$33,527.27.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{data breach} data breaches will cost \$3,576 or more in a year.  There is a 50\% likelihood that they will cost \$16,731 or more in a year.  There is a 10\% chance that they will cost \$29,778 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_persDataBreach.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 6 and 29 possible personal data breaches over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-databreach-count-histo}
\end{figure}
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_persDataBreach_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 10\% probability that at least 8 personal data breaches will occur within the sample.  There is a 50\% chance that 17 or more\index{personal data breach} data breaches will occur within the \index{sample} sample.  There is a 90\% chance that 26 personal data breaches will occur. \protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-databreach-count-percent}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the breaches would cost \$0.  We set an upper bound that the breaches would cost \$105,286.17.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-databreach-impact-histo}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{personal data breach} personal data breaches will cost \$11,776 or more in a year.  There is a 50\% likelihood that they will cost \$52,828 or more in a year.  There is a 10\% chance that they will cost \$92,954 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-databreach-impact-percent}
\end{figure}
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_malware.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 0 and 2 possible malware events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-malware-count-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_malware_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 50\% probability that 0.5 or more\index{malware} malware events will occur within the \index{sample} sample.  This unusual result is because the confidence bounds are between 0 and 1.  We interpret this as a 50\% probability that one malware event will occur. \protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-malware-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_malware_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the events would cost at \$0.  We set an upper bound that the events would cost \$649.99.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/percent_malware_impact.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{malware} malware events will cost \$73.68 or more in a year.  There is a 50\% likelihood that they will cost \$330.68 or more in a year.  There is a 10\% chance that they will cost \$577.98 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_phishing.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 3 and 12 possible phishing events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-phishing-count-histo}
\end{figure}
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/discrete_phishing_count.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 7 and 11 possible phishing events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{table}[H]
  \centering
  \caption{Monte Carlo Discrete Simulation Values for Phishing}
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_phishing_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that 4 or more\index{phishing} phishing events will occur within the \index{sample} sample.  There is a 50\% probability that at least 7 events will occur.  There is a 10\% probability that 10 or more events will occur.  \protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-phishing-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_phishing_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the events would cost at \$0.  We set an upper bound that the events would cost \$40,268.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{phishing} phishing events will cost \$4,661.40 or more in a year.  There is a 50\% likelihood that they will cost \$20,179.13 or more in a year.  There is a 10\% chance that they will cost \$35,678.52 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 0 and 1 possible ransomware events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{ransomware} ransomware events will cost \$374.59 or more in a year.  There is a 50\% likelihood that they will cost \$1,753.25 or more in a year.  There is a 10\% chance that they will cost \$3,113.35 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_children.png}}}
  ...
  \label{fig:screenshot-montecarlo-children-count-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/percent_children_impact}}}
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_extortion.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 6 and 22 possible extortion events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-extortion-count-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_extortion_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 10\% probability that at least 7 extortion events will occur within the sample.  There is a 50\% chance that 14 or more\index{extortion} extortion events will occur within the \index{sample} sample.  There is a 90\% chance that 20 extortion events will occur. \protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-extortion-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_extortion_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the event would cost at \$0.  We set an upper bound that the event would cost \$51,288.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{extortion} extortion events will cost \$5,904.43 or more in a year.  There is a 50\% likelihood that they will cost \$25,575.87 or more in a year.  There is a 10\% chance that they will cost \$45,545.84 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[scale=0.50]{figures/histogram_threats.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 7 and 11 possible threat (threats, stalking, harrassment, and terrorism) events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_threats_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 10\% probability that at least 7 threat events will occur within the sample.  There is a 50\% chance that 8 or more\index{extortion} threat events will occur within the \index{sample} sample.  There is a 90\% chance that 10 threat events will occur. \protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-threat-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_threat_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the event would cost at \$0.  We set an upper bound that the event would cost \$7,112.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{threat} threat events will cost \$780.19 or more in a year.  There is a 50\% likelihood that they will cost \$3,539.18 or more in a year.  There is a 10\% chance that they will cost \$6,263.78 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_ipr.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 1 and 0 possible intellectual property rights events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-ipr-count-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_ipr_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 50\% chance that an\index{intellectual property rights} intellectual property rights event will occur within the \index{sample} sample. \protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-ipr-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_ipr_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the event would cost at \$0.  We set an upper bound that the event would cost \$5,082.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-ipr-impact-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/percent_ipr_impact.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that\index{intellectual property rights} intellectual property rights events will cost \$537.45 or more in a year.  There is a 50\% likelihood that they will cost \$2,511.72 or more in a year.  There is a 10\% chance that they will cost \$4,544.28 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-ipr-impact-percent}
\end{figure}
%%%%%%%%%%%%%%%%%%%%  IDENTITY THEFT %%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_ipr.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 0 and 11 possible identity theft events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-ipr-count-histo}
\end{figure}
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_idtheft.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 0 and 11 possible \index{identity theft}identity theft events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-idtheft-count-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_idtheft_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% chance that 1 \index{identity theft}identity theft event will occur within the \index{sample} sample.  There is a 50\% chance that 5 \index{identity theft}identity theft events will occur.  There is a 10\% chance that 9 \index{identity theft}identity theft events will occur within the \index{sample} sample.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-idtheft-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_idtheft_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the event would cost at \$0.  We set an upper bound that the event would cost \$110,534.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that \index{identity theft}identity theft events will cost \$13,179.42 or more in a year.  There is a 50\% likelihood that they will cost at least \$54,837.49 in a year.  There is a 10\% chance that they will cost \$99,073.35 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_bec.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We bounded between 0 and 13 possible \index{business email compromise}business email compromise events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-bec-count-histo}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/count_bec_percentile.png}}}
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% chance that 1 \index{business email compromise}business email compromise event will occur within the \index{sample} sample. there is a 50\% chance that 6 \index{business email compromise}business email compromise events will occur.  There is a 10\% chance that 11 \index{business email compromise}business email compromise event will occur within the \index{sample} sample.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-bec-count-percent}
\end{figure}

\begin{figure}[H]
  \centering
  \rotatebox{0}{\scalebox{1}{\includegraphics[width=\linewidth]{figures/histogram_bec_impact.png}}}
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the event would cost at \$0.  We set an upper bound that the event would cost \$481,055.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\begin{figure}[H]
  ...
  \caption{A\index{Monte Carlo simulation} Monte Carlo simulation suggests that there is a 90\% probability that \index{business email compromise}business email compromise events will cost \$52,083.89 or more in a year.  There is a 50\% likelihood that they will cost \$23,991.38 or more in a year.  There is a 10\% chance that they will cost \$427,352.39 or more in a year. \protect\endnote{\index{sample} sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set 10\% and 90\%\index{confidence interval} confidence intervals with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime impact values respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
We chose \gls{ic3} crime data from \index{American Samoa} American Samoa to act as our 10\% confidence limit.  We chose data from California to act as our 90\% confidence limit.  We set those limits by looking at seven year spans of crime data and taking the median.  This means we would be likely to have observations above and below the limits, but that the limits themselves would have a basis in observation.
...
\index{mac!biba}\Gls{biba} is a mandatory access control scheme, similar to military multilevel security classifications, but with an emphasis on file integrity. \texttt{mac\_biba} allows for write down and read up; this is the opposite direction from mandatory access control schemes like military security classifications which can write up and read down. \endnote{Martins, Gary R., et al. Implementing Message Systems in Multilevel Secure Environments: Problems and Approaches. Rand, 1982.}\endnote{Biba, K J, et al. Integrity Considerations for Secure Computer Systems. 1977.} FreeBSD offers \texttt{mac\_biba} as part of its operating system; unfortunately, OpenBSD does not.  \endnote{"Mac\_Biba(4)." Freebsd.Org, 2025, \url{https://man.freebsd.org/cgi/man.cgi?query=mac_biba&sektion=4&apropos=0&manpath=freebsd+15.1-release+and+ports}. Accessed 13 July 2026.}
