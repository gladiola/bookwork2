...
\subsection{Configure for SWAP Disk, ZFS  \index{cache}\Gls{cache}, ZFS SLOG \Gls{mirror}, and ZFS RAIDz2}
...
\subsection{ \index{encrypt}\Gls{encrypt} those partitions}
...
\subsection{Commands to  \index{encrypt}\Gls{encrypt} the Partitions}
