...
%%%%%%%%%%%%%%%%%%%%  PHISHING %%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\newlength{\savedintextsepphishing}
\newlength{\savedtextfloatsepphishing}
\setlength{\savedintextsepphishing}{\intextsep}
\setlength{\savedtextfloatsepphishing}{\textfloatsep}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{@{}>{\centering\arraybackslash}p{0.05\linewidth} >{\centering\arraybackslash}
  p{0.16\linewidth}>{\centering\arraybackslash}
  p{0.16\linewidth}>{\centering\arraybackslash}
  p{0.16\linewidth}>{\centering\arraybackslash}
  p{0.16\linewidth}>{\centering\arraybackslash}
  p{0.16\linewidth}>{\centering\arraybackslash}  
...
\end{table}
\FloatBarrier
\setlength{\intextsep}{\savedintextsepphishing}
\setlength{\textfloatsep}{\savedtextfloatsepphishing}
\begin{figure}[H]
  \centering
