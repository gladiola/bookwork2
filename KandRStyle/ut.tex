...
"Quasi-experiments share with all other experiments a similar purpose -- to test descriptive causal hypotheses about manipulatable causes ... \endnote{Ibid.}(p. 14)"
...
% Shadish Text
% Quotations from William Shadish's book, Experimental and Quasi-Experimental Designs for Generalized Causal Inference. \endnote{Ibid.}
...
%REF Shadish
\bibitem{Shadish12A}
Shadish, William, \endnote{Ibid.}, p. 12:
...
%REF Shadish p.18A
\bibitem{Shadish18A}
Shadish, William, \endnote{Ibid.}, p.18.
...
%REF Shadish
\bibitem{Shadish24A}
Shadish, William, \endnote{Ibid.}, p. 24:
