...
\begin{table}[htbp]
\centering
\caption{Alignment of Retained Cybercrime Categories with MITRE ATT\&CK Techniques (Part 1 of 2)}
\label{tab:attack_alignment_1}
\begin{tabular}{|p{3.0cm}|p{3.5cm}|p{5.5cm}|}
\hline
\textbf{Category} & \textbf{ATT\&CK Tactic} & \textbf{Representative ATT\&CK Techniques} \\
\hline
Personal Data Breach & Collection, Exfiltration & Data from Information Repositories (T1213), Archive Collected Data (T1560), Exfiltration Over Web Services (T1567) \\
\hline
Phishing & Initial Access & Phishing (T1566), Phishing Attachment (T1566.001), Phishing Link (T1566.002), Spearphishing (T1566) \\
\hline
Ransomware & Impact & Data Encrypted for Impact (T1486), Financial Theft (T1657) \\
\hline
Extortion & Impact & Financial Theft (T1657), Data Encrypted for Impact (T1486), Data Leak Threats associated with double-extortion campaigns \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[htbp]
\centering
\caption{Alignment of Retained Cybercrime Categories with MITRE ATT\&CK Techniques (Part 2 of 2)}
\label{tab:attack_alignment_2}
\begin{tabular}{|p{3.0cm}|p{3.5cm}|p{5.5cm}|}
\hline
\textbf{Category} & \textbf{ATT\&CK Tactic} & \textbf{Representative ATT\&CK Techniques} \\
\hline
IPR / Counterfeit & Collection, Exfiltration & Data from Information Repositories (T1213), Exfiltration Over Web Services (T1567), Automated Collection (T1119) \\
\hline
Identity Theft & Credential Access & Credentials from Password Stores (T1555), Steal or Forge Authentication Credentials (T1649), Brute Force (T1110) \\
\hline
BEC & Initial Access, Credential Access, Impact & Phishing (T1566), Valid Accounts (T1078), Financial Theft (T1657), Account Manipulation (T1098) \\
\hline
\end{tabular}
\end{table}
