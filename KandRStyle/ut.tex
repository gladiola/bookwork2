...
\renewcommand{\@chapter}[2][]{%
  ...
  \immediate\write\@enotes{\string\enotechapsep{\the\numexpr\value{chapter}+1}{\expandafter\detokenize\expandafter{\currentchaptertitle}}}%
...
\renewcommand{\@schapter}[1]{%
  ...
  \immediate\write\@enotes{\string\enotechapsep{0}{\expandafter\detokenize\expandafter{\currentchaptertitle}}}%
