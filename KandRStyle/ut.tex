...
\[
R = \frac{c_2}{c_1} \sum_{j=t}^{t+6} M_{i,j}
\]

\[
\text{where } M = 
\text{Categories } \left\{ \begin{matrix} 1 \\ \vdots \\ i \\ \vdots \\ m \end{matrix} \right.
\begin{bmatrix}
 \overbrace{\begin{matrix} a_{1,1} & a_{1,2} & \cdots & a_{1,t} & \cdots & a_{1,t+6} & \cdots & a_{1,n} \end{matrix}}^{\text{Years}} \\
 \vdots & \vdots & \ddots & \vdots & \ddots & \vdots & \ddots & \vdots \\
 a_{i,1} & a_{i,2} & \cdots & \mathbf{a_{i,t}} & \cdots & \mathbf{a_{i,t+6}} & \cdots & a_{i,n} \\
 \vdots & \vdots & \ddots & \vdots & \ddots & \vdots & \ddots & \vdots \\
 a_{m,1} & a_{m,2} & \cdots & a_{m,t} & \cdots & a_{m,t+6} & \cdots & a_{m,n}
\end{bmatrix}
\]
