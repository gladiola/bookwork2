...
\begin{table}
  ...
  \begin{tabular}{@{}p{0.15\linewidth} p{0.40\linewidth}p{0.40\linewidth}p{0.05\linewidth}}
    \toprule
...
\begin{table}
  \centering
  \caption{Cybercrime, City of Chattanooga, System Intrusion Group}
  \label{tab:chattanoogacrime2}
  \begin{tabular}{@{}p{0.05\linewidth} p{0.15\linewidth}p{0.15\linewidth}p{0.15\linewidth}p{0.15\linewidth}p{0.15\linewidth}p{0.05\linewidth}}
    \toprule
    Year
    &Data Breach
...
\begin{table}
  ...
  \begin{tabular}{@{}p{0.05\linewidth} p{0.20\linewidth}p{0.15\linewidth}p{0.35\linewidth}p{0.05\linewidth}}
    \toprule
    \makecell[l]{Year}&\makecell[l]{Crimes Against Children}&\makecell[l]{Extortion}&\makecell[l]{Threats, Stalking,\\Harassment, and Terrorism}&\\
    \midrule
