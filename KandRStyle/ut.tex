...
% Hook into \chapter to capture chapter titles
...
% Mark end of chapter: store chapter info and prepare for next chapter
\newcommand{\markchapterendnotes}{%
  % Flush current endnotes to temp file with chapter marker
  \immediate\write\@enotes{\string\endnotesep{\arabic{chapter}}{\currentchaptertitle}}%
