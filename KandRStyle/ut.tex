...
Table~\ref{tab:cybercrime-anova-summary} provides a comprehensive reference guide for the quantitative analysis conducted on each cybercrime category in this chapter. This table summarizes the locations of lower bound computations, upper bound computations, Monte Carlo simulation figures, and simulation value tables that can be used for risk assessment after ANOVA validation.

\begin{table}[H]
  \centering
  \caption{Summary of Cybercrime Category Analysis References}
  \label{tab:cybercrime-anova-summary}
  \small
