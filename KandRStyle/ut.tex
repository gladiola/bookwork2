...
John O\string'Keefe-Odom received a Master of Liberal Arts (ALM) in Extension Studies in the field of Cybersecurity from Harvard Univerisity, Harvard University Extension School in 2026.  He holds various technical certifications in cybersecurity including:  CISSP, CSSLP, CCSP, SecurityX, PenTest+, CySA+, Security+, and Linux+.  He has worked as a senior application security engineer and software engineer for various companies for over ten years.  
