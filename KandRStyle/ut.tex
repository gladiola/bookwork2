...
\item We set mean summary counts from\index{American Samoa} American Samoa as our 10\% interval.
\item We set mean summary counts from\index{California} California as our 90\% interval.
...
\begin{figure}[H]
  ...
  \[
\mathrm{CI}_{80\%}(\theta) = [\$5,081,  \$41,415]
\]
