...
\hline
Phishing & Phishing (T1566), Phishing Attachment (T1566.001), Phishing Link (T1566.002), Spearphishing (T1566) \\
\hline
Ransomware & Data Encrypted for Impact (T1486), Financial Theft (T1657) \\
\hline
...
\hline
Identity Theft & Credentials from Password Stores (T1555), Steal or Forge Authentication Credentials (T1649), Brute Force (T1110) \\
\hline
