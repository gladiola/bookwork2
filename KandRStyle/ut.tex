...
\[
\bar{X}_{\text{American Samoa}} = \frac{1}{N}\sum_{i=1}^{N} X_{\text{American Samoa},i} = 3
\]
\[
\bar{X}_{\text{California}} = \frac{1}{N}\sum_{i=1}^{N} X_{\text{California},i} = 12
\]
\[
[\bar{X}_{\text{American Samoa}},\ \bar{X}_{\text{California}}]
\quad \text{with } \bar{X}_{\text{American Samoa}} \le \bar{X}_{\text{California}}
\]
\[
\mathrm{CI}_{1-\alpha},\quad
\alpha=0.80\ \text{(for 80\% CI)}.
\]
...
\begin{figure}[H]
  ...
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations with a normal distribution to spread random instances between confidence intervals taken from means of a seven year sample. We set a lower bound that the events would cost at \$0.  We set an upper bound that the events would cost \$40,268.  \protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set upper and lower bounds with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
  \label{fig:screenshot-montecarlo-phishing-impact-histo}
\end{figure}
\[
\bar{X}_{\text{American Samoa}} = \frac{1}{N}\sum_{i=1}^{N} X_{\text{American Samoa},i} = \$0
\]
\[
\bar{X}_{\text{California}} = \frac{1}{N}\sum_{i=1}^{N} X_{\text{California},i} = \$40,268
\]
\[
[\bar{X}_{\text{American Samoa}},\ \bar{X}_{\text{California}}]
\quad \text{with } \bar{X}_{\text{American Samoa}} \le \bar{X}_{\text{California}}
...
\begin{figure}[H]
  ...
  \caption{We ran a\index{Monte Carlo simulation} Monte Carlo simulation of 10,000 iterations with a discrete distribution to spread random instances between confidence intervals taken from the means of seven year samples. We bounded between 0 and 11 possible threat (threats, stalking, harrassment, and terrorism) events over a year.\protect\endnote{\index{sample} Sample size was set equivalent to the City of\index{Chattanooga} Chattanooga to determine the per capita rates for each year over data from \index{American Samoa} American Samoa and\index{California} California.  The medians of those rates were used to set upper and lower bounds with \index{American Samoa} American Samoa and\index{California} California representing low and high \index{cybercrime} cybercrime counts respectively.}
  \protect\endnote{Monte Carlo Modeling Toolkit authored by Derek E. Brink, CISSP, \url{www.linkedin.com/in/derekbrink}. March 2023.}
  }
...
\\
    ...
    \end{tabular}
    \end{center}
  \raggedright{A\index{Monte Carlo simulation} Monte Carlo simulation was run using a discrete distribution.  We bounded the simulation between 0 and 7 events.  We assigned a 12.5\% likelihood to each bin.  The resulting distribution showed the effect of randomness on each possible outcome.}
\end{table}
