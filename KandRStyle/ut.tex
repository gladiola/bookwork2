...
\xpatchcmd{\@chapter}%
  {\if@openright}% search for this at the beginning of \@chapter
  {\renewcommand{\currentchaptertitle}{##1}\if@openright}% prepend our code
...
\xpatchcmd{\@schapter}%
  {\@mkboth}% search for this in \@schapter
  {\renewcommand{\currentchaptertitle}{##1}\@mkboth}% prepend our code
