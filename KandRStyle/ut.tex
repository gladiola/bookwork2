...
%REF Lin
\bibitem{LinH97B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 97-98:
...
%REF Lin
\bibitem{LinH98B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 98:
...
%REF Lin
\bibitem{LinH99B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 99-100:
...
%REF Lin
\bibitem{LinH101A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 101:
...
%REF Lin
\bibitem{LinH102B}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p.  102:
...
%REF Lin
\bibitem{LinH103A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 103:
...
%REF Lin
\bibitem{LinH104A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 104:
...
%REF Lin
\bibitem{LinH106A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 106
...
%REF Lin
\bibitem{LinH107A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 107:
...
%REF Lin
\bibitem{LinH108A}
Lin, Herbert, \endnote{Kampf, David, ed.; Lin, Herbert. "Attribution of Malicious Cyber Incidents: From Soup to Nuts," Journal of International Affairs. pp.75-138. Winter 2016, Volume 70, Number 1. JIA.SIPA.COLUMBIA.EDU. Columbia University. This article outlines the difficulties in correctly attributing a cyberattack. Lin points out that we may have weak definitions for the goals of attribution, encounter substantial legal and technical problems, and can expect little relief for victims who ask that attribution of an \gls{attack} be obtained. Lin, like Benjamin Dean, authored an article whose references led me to other references.}, p. 108-109
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-databreach-count-\gls{binary}}
\end{figure}
...
\newpage
\subsection{Personal \gls{databreach}}
\subsubsection{Lower Bound Computation}
\[
\begin{bmatrix}
\mathbf{x}_{\text{American Samoa}}^{(\text{count})}\\
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-\gls{malware}-count-\gls{binary}}
\end{figure}
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-\gls{malware}-impact-histo}
\end{figure}
\begin{figure}[H]
  \centering
...
\]
  ...
  \label{fig:screenshot-montecarlo-\gls{malware}-impact-percent}
\end{figure}

%%%%%%%%%%%%%%%%%%%%  PHISHING %%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection{\gls{phishing}}
\subsubsection{Lower Bound Computation}
\[
\begin{bmatrix}
\mathbf{x}_{\text{American Samoa}}^{(\text{count})}\\
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-\gls{phishing}-count-discrete}
\end{figure}
...
\]
  ...
  \label{fig:screenshot-montecarlo-\gls{phishing}-impact-percent}
\end{figure}
%%%%%%%%%%%%%%%%%%%%  RANSOMWARE %%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection{\gls{ransomware}}
\begin{figure}[H]
  \centering
  ...
  \label{fig:screenshot-montecarlo-\gls{ransomware}-count-histo}
\end{figure}
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-\gls{ransomware}-impact-percent}
\end{figure}
\FloatBarrier
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-\gls{threat}-impact-histo}
\end{figure}
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-ipr-count-\gls{binary}}
\end{figure}
...
\begin{figure}[H]
  ...
  \label{fig:screenshot-montecarlo-ipr-impact-histo-\gls{binary}}
\end{figure}
...
\]
  ...
  \label{fig:screenshot-montecarlo-ipr-impact-percent-\gls{binary}}
\end{figure}
...
\begin{itemize}
	\item an \gls{os} \Gls{\gls{mirror}} pair
...
\begin{itemize}
	\item \gls{jail} \gls{\gls{configuration}}
...
We can build our keys using the live disc's  \gls{shell}. and a  \gls{\gls{thumbdrive}}.  The main command to build the keys is:\\\\
...
\texttt{ \index{gpart!add}gpart add -a 1m -l \gls{zfs}\_NUMBER \textbackslash\\ -t freebsd-zfs DISK\_DEVICE}\endnote{Ibid.}\\\\
\texttt{ \index{gpart!add}gpart add -a 1m -l \gls{zfs}-BLONDIE-4-WD123465789 \textbackslash\\-t freebsd-zfs  da4}\endnote{Ibid.}
\\
...
\texttt{\index{zpool!add}zpool add BLONDIE-MAIN log \gls{mirror} \textbackslash}\endnote{Ibid.}\\
...
\texttt{\index{gpart!add}gpart add -a 5K -s 395G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-0-SWAP-WCC2ERZ56512 mfid0}\endnote{Ibid.}

\subsubsection{Create \gls{zfs} \gls{cache} in Bay 1}
\texttt{\index{gpart!create}gpart create -s GPT mfid1}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -a 5K -s 63G -t freebsd-zfs \textbackslash\\-l \gls{zfs}-BLONDIE-1-\gls{cache}-WXL1E40C1352 mfid1}\endnote{Ibid.}

\subsubsection{Create \gls{zfs} SLOG in Bays 2 and 3}
\texttt{\index{gpart!create}gpart create -s GPT mfid2}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -a 5K -s 63G -t freebsd-zfs \textbackslash\\-l \gls{zfs}-BLONDIE-2-SLOG-WXL1E4067503 mfid2}\endnote{Ibid.}\\\\
\texttt{\index{gpart!create}gpart create -s GPT mfid3}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -a 5K -s 63G -t freebsd-zfs \textbackslash\\ -l \gls{zfs}-BLONDIE-3-SLOG-WXC0CA9V8431 mfid3}\endnote{Ibid.}\\\\

\subsubsection{Create \gls{zfs} Work Disks for Jails}
\subsubsection{Bay 4}
\texttt{\index{gpart!create}gpart create -s GPT mfid4}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -a 5K -s 50G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-4-SWAP-WCC2EE134983 mfid4}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -s 345G -t freebsd-zfs \textbackslash\\-l \gls{zfs}-BLONDIE-4-FILES-WCC2EE134983 mfid4}\endnote{Ibid.}
\subsubsection{Bay 5}
\texttt{\index{gpart!create}gpart create -s GPT mfid5}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -a 5K -s 50G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-5-SWAP-WMC2E3914420 mfid5}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -s 345G -t freebsd-zfs \textbackslash\\-l \gls{zfs}-BLONDIE-5-FILES-WMC2E3914420 mfid5}\endnote{Ibid.}
\subsubsection{Bay 6}
\texttt{\index{gpart!create}gpart create -s GPT mfid6}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -a 5K -s 50G -t freebsd-swap \textbackslash\\ -l \gls{zfs}-BLONDIE-6-SWAP-WCC2ETT39577 mfid6}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -s 345G -t freebsd-zfs \textbackslash\\-l \gls{zfs}-BLONDIE-6-FILES-WCC2ETT39577 mfid6}\endnote{Ibid.}
\subsubsection{Bay 7}
\texttt{\index{gpart!create}gpart create -s GPT mfid7}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -a 5K -s 50G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-7-SWAP-WCAYU2878968 mfid7}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -s 345G -t freebsd-zfs \textbackslash\\-l \gls{zfs}-BLONDIE-7-FILES-WCAYU2878968 mfid7}\endnote{Ibid.}\\
...
\texttt{\index{cp}cp /var/backups/mfid1p1.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-1-\gls{cache}-WXL1E40C1352.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid2p1.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-2-SLOG-WXL1E4067503.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid3p1.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-3-SLOG-WXC0CA9V8431.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid4p1.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-4-SWAP-WCC2EE134983.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid4p2.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-4-FILES-WCC2EE134983.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid5p1.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-5-SWAP-WMC2E3914420.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid5p2.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-5-FILES-WMC2E3914420.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid6p1.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-6-SWAP-WCC2ETT39577.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid6p2.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-6-FILES-WCC2ETT39577.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid7p1.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-7-SWAP-WCAYU2878968.eli}\endnote{Ibid.}\\\\
\texttt{\index{cp}cp /var/backups/mfid7p2.eli /tmp/usb3/backups\\\_27SEP2020/\gls{zfs}-BLONDIE-7-FILES-WCAYU2878968.eli}\endnote{Ibid.}
...
\noindent\texttt{ \index{gpart!modify}gpart modify -i 1 \textbackslash\\-l \gls{zfs}-BLONDIE-4-SWAP-WCC2EE134983 mfid4}\endnote{Ibid.}\\\\
\texttt{ \index{gpart!modify}gpart modify -i 2 \textbackslash\\-l \gls{zfs}-BLONDIE-4-FILES-WCC2EE134983 mfid4}\endnote{Ibid.}\\
...
\texttt{\index{gpart!add}gpart add -s 64G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-0-SWAP-C-WCC2ERZ56512 mfid0}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -s 64G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-0-SWAP-D-WCC2ERZ56512 mfid0}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -s 64G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-0-SWAP-E-WCC2ERZ56512 mfid0}\endnote{Ibid.}\\\\
\texttt{\index{gpart!add}gpart add -s 64G -t freebsd-swap \textbackslash\\-l \gls{zfs}-BLONDIE-0-SWAP-F-WCC2ERZ56512 mfid0}\endnote{Ibid.}\\\\
