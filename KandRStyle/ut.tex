...
\subsection{Incremental Advancement to \gls{Amnesiac} System}
With all of the manual coding and configuration needed to set up an \gls{amnesiac} system like the one we desired, it was a big change from the normal \gls{bsd} installs we had done for several years.  Our first pass at building an \gls{amnesiac} system decayed into manually scripting a regular operating system installation that had most of the features we desired in the \gls{amnesiac} system.  Both the on-disc OS system and the \gls{amnesiac} system are detailed below.  
...
\subsection{Goals for \gls{amnesiac} Systems}
