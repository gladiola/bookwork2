...
\newcommand{\starchapter}[1]{%
  ...
  \oldchapter*{#1}%
  % Write separator after starting new chapter (for starred chapters, use 0)
  \immediate\write\@enotes{\string\enotechapsep{0}{#1}}%
}
\newcommand{\nostarchapter}[1]{%
  \renewcommand{\currentchaptertitle}{#1}%
  \oldchapter{#1}%
  % Write separator after starting new chapter (counter is now incremented)
  \immediate\write\@enotes{\string\enotechapsep{\arabic{chapter}}{#1}}%
}
\makeatother
