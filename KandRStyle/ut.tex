...
\texttt{\index{geli}geli attach [DISK\_NAMEpPARTITION\_NUMBER]}\endnote{"Geli(8)." Freebsd.org, 2025, \url{man.freebsd.org/cgi/man.cgi?query=geli&sektion=8&manpath=FreeBSD+10.3-RELEASE}. Accessed 10 June 2026.}
...
\texttt{\index{zpool}zpool import POOL\_NAME\_ON\_ATTACHED\_DISK}\endnote{"zpool(8)." Freebsd.org, 2026, \url{man.freebsd.org/cgi/man.cgi?query=zpool&sektion=8&manpath=FreeBSD+10.3-RELEASE}. Accessed 10 June 2026.}
